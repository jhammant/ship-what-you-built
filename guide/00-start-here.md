...
[the three layers](01-three-layers.md), and it's the next page.
...
# gh and awscli have their own installers — see guide/02-github.md
```

| Tool | What it's for | Used in |
|---|---|---|
| `git` | tracks your changes | everywhere |
| `gh` | GitHub from the command line | [02](02-github.md) |
| `curl` | fetching a URL to check it works | everywhere |
| `dig` | asking DNS questions directly | [01](01-three-layers.md), troubleshooting |
...
>    Fine for Track A and for [02](02-github.md). Track B's heredocs mostly work,
...
1. **[Understand the three layers](01-three-layers.md)** — ten minutes of
...
2. **[Get your code on GitHub](02-github.md)** — both tracks deploy *from* a
...
> straight to your track. Come back to [02](02-github.md) at the "what counts as
...
**You can still use this guide.** Do [01](01-three-layers.md) and
[02](02-github.md), buy your domain via whichever track you prefer, and then use
...
**Next:** [The three layers →](01-three-layers.md)
